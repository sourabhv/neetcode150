...
<li class="flex justify-between gap-x-6 py-3 items-center">
	...
	<button
		...
		class="flex flex-row items-center gap-x-2 rounded-md bg-indigo-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm transition-all hover:shadow-xl hover:bg-indigo-700"
	>
		<svg
			width="18px"
			height="18px"
